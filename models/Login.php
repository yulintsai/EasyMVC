...
if($account==null and $password==null){
   echo "<script> alert('請輸入使用者名稱及密碼!');location.href='index.php'</script>t";
}elseif ($account==null ){
   echo "<script> alert('您尚未輸入使用者名稱!');location.href='index.php'</script>";

}elseif($password==null ){
   echo "<script> alert('您尚未輸入密碼!');location.href='index.php'</script>";
}else{
